...
- [x] **Analyze Input Data**: Review sample JSON messages to understand the schema and required transformations.
- [x] **Define Output Schema**: Determine the structure for the NoSQL database (Firestore).
