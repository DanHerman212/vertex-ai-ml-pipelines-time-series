...
for v in {1..9}; do
    ...
    # Syntax: gcloud ai models delete-version MODEL_ID@VERSION_ID
    gcloud ai models delete-version ${MODEL_ID}@${v} --region=$REGION --quiet || echo "Version $v might already be gone."
done
